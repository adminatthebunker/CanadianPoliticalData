...
import publicV1Routes from "./routes/public/index.js";
...
await app.register(chunkRoutes, { prefix: "/api/v1/chunks" });
await app.register(adminRoutes, { prefix: "/api/v1/admin" });
await app.register(authRoutes, { prefix: "/api/v1/auth" });
await app.register(meRoutes, { prefix: "/api/v1/me" });
await app.register(keysRoutes, { prefix: "/api/v1/me/api-keys" });
await app.register(subscriptionsRoutes, { prefix: "/api/v1/me/subscriptions" });
await app.register(publicV1Routes, { prefix: "/api/public/v1" });
