...
const COMMAND_CATALOG = [
  ...
  { key: "ingest-bc-committees", category: "hansard",
    ...
    args: [
      ...
      { name: "limit_speeches", type: "int", required: false, help: "Cap on TOTAL speeches ingested." },
      { name: "committees", type: "string", required: false, help: "Comma-separated committee codes (e.g. 'fgs,cay'). Default: all in seed file." },
      { name: "seed_file", type: "string", required: false, help: "Override seed JSON path. Default: scripts/seeds/bc-committee-meetings.json." },
    ],
  },
